            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-white/60">
                  ...
                  <li>
                    <span className="text-brand-400">◈</span> Mapbox — maps & elevation
                  </li>
                  <li>
                    <span className="text-brand-400">◈</span> Claude AI — content enrichment
                  </li>
                </ul>
              </div>
              <div>
                ...
                <dl className="space-y-1.5 text-sm">
                  <div className="flex gap-3">
                    <dt className="text-white/40 w-24 shrink-0">Last updated</dt>
                    <dd className="text-white/60">
                      {new Date((destination as any).updated_at ?? Date.now()).toLocaleDateString(
                        "en-US",
                  ...
                  <div className="flex gap-3">
                    <dt className="text-white/40 w-24 shrink-0">Category</dt>
                    <dd className="text-white/60 capitalize">{destination.category}</dd>
                  </div>
                  <div className="flex gap-3">
                ...
                <p className="text-white/30 text-xs mt-4 leading-relaxed">
                  Found an error? Have insider knowledge? Email us at{" "}
                  <a href="mailto:hello@anuprijal.com" className="text-brand-400 hover:underline">
                    hello@anuprijal.com
                  </a>
                </p>
              </div>
